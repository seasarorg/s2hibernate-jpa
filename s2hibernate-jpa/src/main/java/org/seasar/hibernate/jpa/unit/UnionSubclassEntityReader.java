 ...
 * @author taedium
 */
public class UnionSubclassEntityReader extends AbstractEntityReader {

    private UnionSubclassEntityPersister persister;

    public UnionSubclassEntityReader(final Object entity,
            final EntityManager em, final UnionSubclassEntityPersister persister) {
